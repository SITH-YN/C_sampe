...
#@   -IC:/GitHub/SITH-YN/C_sample/RL78_G13_Tutorial_Analysis_CC/generate
#@   -character_set=utf8
#@   -o CMakeFiles\CCRL_Project.dir\generate\r_cg_cgc_user.c.obj
#@   -c
#@   C:\GitHub\SITH-YN\C_sample\RL78_G13_Tutorial_Analysis_CC\generate\r_cg_cgc_user.c
#@  compiled at Fri Jan 12 19:03:44 2024

	.PUBLIC _R_CGC_Get_ResetSource

	.SECTION .textf,TEXTF
	.TYPE _R_CGC_Get_ResetSource,function,.LFE1-_R_CGC_Get_ResetSource
_R_CGC_Get_ResetSource:
	.STACK _R_CGC_Get_ResetSource = 6
	;***        1 : /***********************************************************************************************************************
	;***        2 : * DISCLAIMER
	...
	.LINE "C:/GitHub/SITH-YN/C_sample/RL78_G13_Tutorial_Analysis_CC/generate/r_cg_cgc_user.c", 56
	push hl
	;***       57 : {
	;***       58 :     uint8_t reset_flag = RESF;
	.LINE "C:/GitHub/SITH-YN/C_sample/RL78_G13_Tutorial_Analysis_CC/generate/r_cg_cgc_user.c", 58
	mov a, 0xFFFA8
	mov [sp+0x00], a
	pop ax
	ret
